...
##    canvas.rectangle([[0,0],[50, 50]], fill='green', outline='red')
      canvas.polygon([[-30,0], [10,00], [00,100]], fill = 'black', outline='cyan', width=3, stipple = 'gray25')
##    canvas.polygon([[10, -50], [100, -50], [80, 60]], fill = 'cornflowerblue', outline='blue', width=3)
##    canvas.polygon([[-70, -50], [-10, -50], [-30, 30]], fill = 'lightgreen', outline='blue', width=3)
